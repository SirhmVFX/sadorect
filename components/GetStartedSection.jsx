...
function GetStartedSection() {
  return (
    <>
      <section className="bg-white rounded-3xl p-6 md:p-10 flex flex-col gap-4 md:gap-8">
        <div className="flex md:flex-row flex-col gap-8 items-center">
          ...
          <div className="flex md:flex-row flex-col md:w-2/4 gap-4 md:gap-8">
            <div className="flex items-center gap-4 p-4 md:p-6 rounded-lg bg-gray-50">

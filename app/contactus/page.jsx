...
function ContactUs() {
  return (
    <>
      <section className="md:w-5/6 mx-auto p-6 md:p-10">
        <div className="md:w-4/6 flex md:flex-row flex-col gap-8 items-center mx-auto p-10 rounded-xl bg-white shadow-gray-200 shadow-lg">
          <div className="md:w-3/5 flex flex-col gap-2 md:gap-4">
            <h1 className="text-gray-500">Contact</h1>
            <h1 className="font-bold text-primarycolor text-xl md:text-5xl">
              You have a project? or want to say hello...
            </h1>
            <Link
              className="font-bold text-gray-300 text-md md:text-4xl"
              href={"#"}
            >
              info@sadorect.com
            </Link>
        ...
        <div className="md:w-4/6 mx-auto flex flex-col gap-4 p-2 md:p-8 items-center">
